...
function html5blank_styles()
{
	...
	wp_register_style('html5blank', get_template_directory_uri() . '/style.css', array(), '2.1', 'all');
	wp_enqueue_style('html5blank'); // Enqueue it!

	wp_register_style('grid', get_template_directory_uri() . '/grid12.css', array(), '1.0', 'all');
	wp_enqueue_style('grid'); // Enqueue it!

	wp_register_style('responsive', get_template_directory_uri() . '/responsive.css', array(), '2.1', 'all');
